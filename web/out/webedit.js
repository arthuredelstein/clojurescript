...
var out = {};
var G__4228_4230 = cljs.core.seq.call(null,m);
while(true){
if(G__4228_4230)
{var vec__4229_4231 = cljs.core.first.call(null,G__4228_4230);
var k_4232 = cljs.core.nth.call(null,vec__4229_4231,0,null);
var v_4233 = cljs.core.nth.call(null,vec__4229_4231,1,null);
(out[cljs.core.name.call(null,k_4232)] = v_4233);
{
var G__4234 = cljs.core.next.call(null,G__4228_4230);
G__4228_4230 = G__4234;
continue;
}
} else
{}
...
var js_key_map = webedit.map__GT_js.call(null,cljs.core.into.call(null,cljs.core.ObjMap.EMPTY,(function (){var iter__2103__auto__ = (function iter__4239(s__4240){
return (new cljs.core.LazySeq(null,false,(function (){
var s__4240__$1 = s__4240;
while(true){
if(cljs.core.seq.call(null,s__4240__$1))
{var vec__4242 = cljs.core.first.call(null,s__4240__$1);
var k = cljs.core.nth.call(null,vec__4242,0,null);
var callback = cljs.core.nth.call(null,vec__4242,1,null);
return cljs.core.cons.call(null,cljs.core.PersistentVector.fromArray([[cljs.core.str(webedit.command_prefix),cljs.core.str("-"),cljs.core.str(k)].join(''),callback], true),iter__4239.call(null,cljs.core.rest.call(null,s__4240__$1)));
} else
{return null;
}
break;
...
return iter__2103__auto__.call(null,key_map);
})()));
...
var G__4244 = CodeMirror.fromTextArea(document.getElementById("editor"),webedit.map__GT_js.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'mode","\uFDD0'lineNumbers","\uFDD0'matchBrackets"],{"\uFDD0'mode":"clojure","\uFDD0'lineNumbers":true,"\uFDD0'matchBrackets":true})));
G__4244.setValue((function (){var or__3824__auto__ = webedit.load_item.call(null,"scratch");
...
var G__4245__delegate = function (m){
...
return G__4245__delegate.call(this, m);
};
G__4245.cljs$lang$maxFixedArity = 0;
G__4245.cljs$lang$applyTo = (function (arglist__4246){
var m = cljs.core.seq(arglist__4246);;
return G__4245__delegate(m);
});
G__4245.cljs$lang$arity$variadic = G__4245__delegate;
return G__4245;
})()
,cljs.core.hash_map("\uFDD0'defs",cljs.core.hash_map((new cljs.core.Symbol(null,"setup-editor-toggling")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/setup-editor-toggling")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",0,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",64,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs"),(new cljs.core.Symbol(null,"load-item")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([(new cljs.core.Symbol(null,"key"))]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"key")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/load-item")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",1,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'doc","Reads text at key in localStorage.","\uFDD0'line",12,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs"),(new cljs.core.Symbol(null,"editor-visible-key")),cljs.core.hash_map("\uFDD0'line",45,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs","\uFDD0'name",(new cljs.core.Symbol(null,"webedit/editor-visible-key"))),(new cljs.core.Symbol(null,"update-link")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([(new cljs.core.Symbol(null,"show?"))]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"show?")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/update-link")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",1,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",56,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs"),(new cljs.core.Symbol(null,"store-item")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([(new cljs.core.Symbol(null,"key")),(new cljs.core.Symbol(null,"text"))]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"key")),"\uFDD0'tag",null,"\uFDD0'shadow",null),cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"text")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/store-item")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",2,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'doc","Writes text at key in localStorage.","\uFDD0'line",7,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs"),(new cljs.core.Symbol(null,"map->js")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([(new cljs.core.Symbol(null,"m"))]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"m")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/map->js")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",1,"\uFDD0'private",true,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",19,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs"),(new cljs.core.Symbol(null,"register-shortcuts")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([(new cljs.core.Symbol(null,"editor")),(new cljs.core.Symbol(null,"key-map"))]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"editor")),"\uFDD0'tag",null,"\uFDD0'shadow",null),cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"key-map")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/register-shortcuts")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",2,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",33,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs"),(new cljs.core.Symbol(null,"/")),cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"cljs.core//"))),(new cljs.core.Symbol(null,"editor-visible")),cljs.core.hash_map("\uFDD0'line",43,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs","\uFDD0'name",(new cljs.core.Symbol(null,"webedit/editor-visible"))),(new cljs.core.Symbol(null,"add-updating-watch")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([(new cljs.core.Symbol(null,"reference")),(new cljs.core.Symbol(null,"fun"))]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"reference")),"\uFDD0'tag",null,"\uFDD0'shadow",null),cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"fun")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/add-updating-watch")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",2,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",61,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs"),(new cljs.core.Symbol(null,"str-contains?")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([(new cljs.core.Symbol(null,"s")),(new cljs.core.Symbol(null,"x"))]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"s")),"\uFDD0'tag",null,"\uFDD0'shadow",null),cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"x")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/str-contains?")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",2,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",25,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs"),(new cljs.core.Symbol(null,"editor")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/editor")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",0,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",73,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs"),(new cljs.core.Symbol(null,"command-prefix")),cljs.core.hash_map("\uFDD0'line",31,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs","\uFDD0'name",(new cljs.core.Symbol(null,"webedit/command-prefix"))),(new cljs.core.Symbol(null,"update-editor-visibility")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([(new cljs.core.Symbol(null,"show?"))]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"show?")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/update-editor-visibility")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",1,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",47,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs"),(new cljs.core.Symbol(null,"store-editor-visibility")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([(new cljs.core.Symbol(null,"show?"))]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([cljs.core.hash_map("\uFDD0'name",(new cljs.core.Symbol(null,"show?")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/store-editor-visibility")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",1,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",53,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs"),(new cljs.core.Symbol(null,"mac?")),cljs.core.hash_map("\uFDD0'arglists",cljs.core.list((new cljs.core.Symbol(null,"quote")),cljs.core.list(cljs.core.vec([]))),"\uFDD0'method-params",cljs.core.list(cljs.core.vec([])),"\uFDD0'name",(new cljs.core.Symbol(null,"webedit/mac?")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",0,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",28,"\uFDD0'fn-var",true,"\uFDD0'file","/projects/cljs6.net/clojurescript/src/cljs/webedit.cljs")),"\uFDD0'imports",null,"\uFDD0'uses-macros",null,"\uFDD0'requires",cljs.core.hash_map((new cljs.core.Symbol(null,"repl")),(new cljs.core.Symbol(null,"cljs.repl"))),"\uFDD0'uses",null,"\uFDD0'excludes",cljs.core.set([]),"\uFDD0'doc",null,"\uFDD0'name",(new cljs.core.Symbol(null,"webedit"))),old);
}));
