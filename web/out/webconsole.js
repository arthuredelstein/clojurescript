...
var prompt_label_4248 = [cljs.core.str("\n"),cljs.core.str(cljs.repl.prompt.call(null))].join('');
var continue_label_4249 = [cljs.core.str(cljs.core.apply.call(null,cljs.core.str,cljs.core.repeat.call(null,(cljs.core.count.call(null,prompt_label_4248) - 4)," "))),cljs.core.str("...")].join('');
jqconsole.SetPromptLabel(prompt_label_4248,continue_label_4249);
jqconsole.Prompt("true",(function (input){
cljs.repl.eval_print.call(null,input);
return start_prompt.call(null,jqconsole);
}),(function (p1__4247_SHARP_){
if(cljs.core.truth_(cljs.repl.complete_form_QMARK_.call(null,p1__4247_SHARP_)))
{return false;
} else
{return 0;
}
...
var G__4251_4252 = jqconsole;
G__4251_4252.ClearPromptText();
G__4251_4252.AbortPrompt();
G__4251_4252.Write(message,"jqconsole-output");
return prompt_text;
});
webconsole.register_shortcuts = (function register_shortcuts(jqconsole,shortcut_map){
var G__4259 = cljs.core.seq.call(null,shortcut_map);
while(true){
if(G__4259)
{var vec__4260 = cljs.core.first.call(null,G__4259);
var key = cljs.core.nth.call(null,vec__4260,0,null);
var callback = cljs.core.nth.call(null,vec__4260,1,null);
jqconsole.RegisterShortcut(key,callback);
{
var G__4261 = cljs.core.next.call(null,G__4259);
G__4259 = G__4261;
continue;
}
} else
...
cljs.core._STAR_out_STAR_ = (function (p1__4253_SHARP_){
return jqconsole.Write(p1__4253_SHARP_);
});
cljs.core._STAR_rtn_STAR_ = (function (p1__4254_SHARP_){
return jqconsole.Write(p1__4254_SHARP_,"jqconsole-output");
});
cljs.core._STAR_err_STAR_ = (function (p1__4255_SHARP_){
return jqconsole.Write(p1__4255_SHARP_,"jqconsole-message-error");
});
cljs.core._STAR_print_fn_STAR_ = (function (p1__4256_SHARP_){
return cljs.core._STAR_out_STAR_.call(null,p1__4256_SHARP_);
});
